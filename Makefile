...
# Project:  Boid.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile Boid.pro
#############################################################################
...
CXXFLAGS      = -pipe -msse -msse2 -msse3 -march=native -g -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
...
COMPRESS      = gzip -9f
DISTNAME      = Boid1.0.0
DISTDIR = /home/yioannidis/NGLDemos/VertexArrayObject/BoidShaded/obj/Boid1.0.0
LINK          = clang++
...
Makefile: Boid.pro ../../.qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile Boid.pro
...
moc/moc_OpenGLWindow.cpp: /opt/qt/5.5/gcc_64/include/QtGui/QWindow \
	...
	/opt/qt/5.5/gcc_64/bin/moc $(DEFINES) -I/opt/qt/5.5/gcc_64/mkspecs/linux-clang -I/home/yioannidis/NGLDemos/VertexArrayObject/BoidShaded -I/home/yioannidis/NGLDemos/VertexArrayObject/BoidShaded/include -I/home/yioannidis/NGL/include -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtOpenGL -I/opt/qt/5.5/gcc_64/include/QtWidgets -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore include/OpenGLWindow.h -o moc/moc_OpenGLWindow.cpp
...
obj/main.o: src/main.cpp include/OpenGLWindow.h \
		...
		/home/yioannidis/NGL/include/ngl/rapidxml/rapidxml.hpp \
